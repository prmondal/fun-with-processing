...
Particle.prototype.getBBox = function() {
  return new BBox(new Point(this.pos.x - this.size / 2, this.pos.y - this.size / 2), new Point(this.pos.x + this.size / 2, this.pos.y + this.size / 2));
};
